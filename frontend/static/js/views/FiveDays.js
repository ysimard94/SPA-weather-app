...
export default class extends AbstractView {
    ...
    async getWeather(city) {
        ...
        const data = await getData(`https://api.openweathermap.org/data/2.5/forecast?q=${city}&appid=38b38e8094299fed3051e1620bb00991&units=metric`)

        // Si la valeur rentrée par l'utilisateur existe et si la valeur n'était pas vide, on boucle 
        // sur les données pour retourner une chaine HTML avec les informations météo
        if (data['cod'] != 404 && data['cod'] != 400) {
            ...
            for(let i in data['list']){
                ...
                day['weather'][0]['description'] = day['weather'][0]['description'][0].toUpperCase() + day['weather'][0]['description'].slice(1)
